...
namespace FrostweepGames.Plugins.WebGLFileBrowser
{
    ...
    public static class FileExtension
	{
        ...
        {
            AudioClip clip = AudioClip.Create(file.fileInfo.name, 0, 1, 48000, false);
            return clip;
        }

        public static bool IsImage(this File file)
		{
            return file.fileInfo.extension.ToLower().EndsWith("png") || file.fileInfo.extension.ToLower().EndsWith("jpeg") || file.fileInfo.extension.ToLower().EndsWith("jpg");
        }

        public static bool IsText(this File file)
        {
            return file.fileInfo.extension.ToLower().EndsWith("txt") || file.fileInfo.extension.ToLower().EndsWith("json");
        }
